"""
MAINet v1 — DualPath v1（每 block 自带 estimator，无参数监督）
=============================================================
...
用法:
  python mainet/v1/train.py --debug --epochs 1              # 冒烟测试
  python mainet/v1/train.py --epochs 100                    # 全量训练
"""
...
class Config:
    ...
    output_dir = os.path.join(_PROJECT_ROOT, "work_dirs/mainet/v1")
...
def build_model(cfg, device):
    ...
    print(f"Model (RCNN/v1 DualPath): {n/1e6:.2f}M params")
...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(description="MAINet v1 — DualPath v1")

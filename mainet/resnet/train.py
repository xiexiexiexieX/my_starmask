...
用法:
  python mainet/resnet/train.py --debug --epochs 1           # 冒烟测试
  python mainet/resnet/train.py --epochs 100                 # 全量训练
"""
...
class Config:
    ...
    output_dir = os.path.join(_PROJECT_ROOT, "work_dirs/mainet/resnet")
...
def build_model(cfg, device):
    ...
    print(f"Model (RCNN/ResNet-18): {n/1e6:.2f}M params")
...
if __name__ == "__main__":
    ...
    ap = argparse.ArgumentParser(description="MAINet ResNet-18 (ablation)")
